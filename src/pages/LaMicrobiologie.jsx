...
const REFERENCES = [
  { id: 'prelevement', label: 'Guide de prélèvement', icone: 'ti-cotton-bud', route: '/labo/microbiologie/prelevement' },
...
export default function LaMicrobiologie() {
  ...
  return (
    <div className="drogues-page">
      ...
      <div className="labo-protocoles-grid">
        {REFERENCES.map(r => (
          <button key={r.id} className="labo-protocole-btn" onClick={() => navigate(r.route)}>
