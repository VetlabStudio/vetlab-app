...
{sousCategoriesDisponibles.length > 0 && (
  ...
  { id: 'furet',        label: 'Furet',              icone: '/icone-furet.svg', ratio: 38 / 30 },
  { id: 'oiseau',       label: 'Oiseau',            icone: '/icone-oiseau.svg' },
  { id: 'serpent',      label: 'Serpent',            icone: '/icone-serpent.svg' },
  { id: 'lezard',       label: 'Lézard',             icone: '/icone-lezard.svg' },
  { id: 'tortue',       label: 'Tortue',             icone: '/icone-tortue.svg' },
  { id: 'poisson',      label: 'Poisson',           icone: '/icone-poisson.svg' },
  { id: 'amphibien',    label: 'Amphibien',         icone: '/icone-grenouille.svg' },
  { id: 'rongeur',      label: 'Rongeur',           icone: '/icone-rongeurs.svg' },
  { id: 'chinchilla',   label: 'Chinchilla',         icone: '/icone-chinchilla.svg' },
  { id: 'cobaye',       label: 'Cochon d\'Inde',     icone: '/icone-cobaye.svg' },
  { id: 'herisson',     label: 'Hérisson',           icone: '/icone-herisson.svg' },
].map(esp => (
