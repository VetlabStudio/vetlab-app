...
function SectionTitre({ titre }) {
  return <h2 className="conversion-section-titre">{titre}</h2>
}
  ...
  return (
    <div className="page-calculateurs">
      <div className="calc-form">
        ...
        {/* ─── TEMPÉRATURE ────────────────────── */}
        <SectionTitre titre="Température" />
