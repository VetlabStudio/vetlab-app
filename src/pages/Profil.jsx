      ...
      <div className="profil-section">
        ...
        {estPro && !estEquipe ? (
          <div className="profil-forfait-item">
            ...
            <p className="profil-forfait-desc" style={{ marginBottom: 14 }}>Vous bénéficiez de toutes les fonctionnalités Pro.</p>
        ...
        {estEquipe ? (
          ...
          <div className="profil-forfait-item" style={{ borderBottom: 'none' }}>
            ...
            <p className="profil-forfait-desc" style={{ marginBottom: 14 }}>
              Passez au forfait Équipe — votre crédit Pro non utilisé est automatiquement déduit. Vous ne perdez pas ce que vous avez déjà payé.
            </p>
          ...
          <div className="popup-card" onClick={e => e.stopPropagation()}>
            ...
            <div style={{ padding: '12px 0 4px' }}>
              <p style={{ fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.6, marginBottom: 16 }}>
                Votre crédit Pro non utilisé sera automatiquement déduit du montant à payer. Vous ne perdez rien.
              </p>
              <p style={{ fontSize: 12, fontWeight: 600, marginBottom: 8 }}>Nombre de membres</p>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
                <button className="radio-btn" onClick={() => setNombreMembres(n => Math.max(2, n - 1))} style={{ width: 32, height: 32, borderRadius: 8 }}>−</button>
      ...
      {modalSieges && (
        <div className="popup-overlay" onClick={() => setModalSieges(false)}>
          <div className="popup-card" onClick={e => e.stopPropagation()}>
            ...
            <div style={{ padding: '12px 0 4px' }}>
              <p style={{ fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.6, marginBottom: 16 }}>
                La différence de prix sera calculée au prorata — vous ne payez que ce qu'il reste de votre période en cours.
              </p>
              <p style={{ fontSize: 12, fontWeight: 600, marginBottom: 8 }}>Nombre de membres</p>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
                <button className="radio-btn" onClick={() => setNombreMembres(n => Math.max(2, n - 1))} style={{ width: 32, height: 32, borderRadius: 8 }}>−</button>
