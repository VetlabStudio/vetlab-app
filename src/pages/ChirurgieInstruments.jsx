...
const INSTRUMENTS = [
  ...
  { nom: 'Porte-aiguille Olsen-Hegar', fichier: 'porte-aiguille-olsen-hega.png', description: 'Instrument 2-en-1 : il permet à la fois de tenir l\'aiguille et de couper le fil, sans changer d\'outil.' },
  ...
  { nom: 'Lame #10', fichier: 'lame-10.png', description: 'Lame de bistouri classique à large tranchant, idéale pour les incisions générales en chirurgie.' },
  { nom: 'Lame #11', fichier: 'lame-11.png', description: 'Présente une pointe fine conçue pour réaliser des incisions de type perforation. Fréquemment employée pour initier l\'ouverture de la ligne blanche.' },
  { nom: 'Lame #15', fichier: 'lame-15.png', description: 'Dotée d\'un tranchant court, elle permet une grande précision lors des sections délicates.' },
  ...
  { nom: 'Curette osseuse de Volkmann', fichier: 'curette-volkmann.png', description: 'Utilisée fréquemment en chirurgie orthopédique pour nettoyer les débris et tissus fibreux présents sur les surfaces osseuses.' },
