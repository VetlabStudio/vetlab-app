...
plantes: [
    ...
    { nom: 'Amanite à acide iboténique (Amanita muscaria / tue-mouches, A. pantherina / panthère)', img: 'amanita-muscaria.jpg', categorie: 'sauvage', especes: ['chien', 'chat'], toxicite: 'Modérée à élevée',
      identification: 'Champignons forestiers faciles à reconnaître : le tue-mouches a un chapeau rouge vif ou orangé couvert de points blancs (les taches peuvent disparaître après la pluie). La panthère a un chapeau brun foncé avec des verrues blanches. Ils poussent au sol dans les forêts du Québec, souvent près de conifères ou de bouleaux, de l\'été à l\'automne.',
      mecanisme: 'Acide iboténique et muscimol, action sur le SNC (GABAergique et glutamatergique)',
      signes: 'Début rapide (30 min à 3h) : alternance de dépression et d\'excitation du SNC, ataxie, désorientation, hypersalivation, mydriase, tremblements, parfois convulsions et coma fluctuant.',
    ...
    { nom: 'Amanite à amatoxines (Amanita phalloides, virosa, ocreata, verna)', img: 'amanita-phalloides.jpg', categorie: 'sauvage', especes: ['chien', 'chat'], toxicite: 'Très élevée (mortelle)',
      identification: 'Ces champignons sont souvent blancs ou verdâtres, avec un anneau autour de la tige et une base renflée en forme de coupe (volve). Ils poussent au sol dans les forêts de feuillus et les forêts mixtes du Québec, en été et en automne. Attention : ils peuvent ressembler à des champignons comestibles.',
      mecanisme: 'Amatoxines (alpha-amanitine), inhibition de l\'ARN polymérase II',
      signes: 'Évolution en trois temps : phase digestive (6-24h : vomissements, diarrhée hémorragique, douleurs abdominales), rémission trompeuse (12-48h), puis insuffisance hépatique aiguë (ictère, hypoglycémie, coagulopathie, encéphalopathie, coma); atteinte rénale possible.',
    ...
    { nom: 'Amaryllis (Hippeastrum)', img: 'amaryllis.jpg', categorie: 'interieur', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Modérée',
      identification: 'Grande fleur en entonnoir, rouge, rose, blanche ou bicolore, portée sur une longue tige creuse. Les feuilles sont longues, vertes et en forme de courroie. Le bulbe ressemble à un oignon. Souvent vendue en kit à faire fleurir à l\'intérieur en hiver.',
      mecanisme: 'Lycorine et alcaloïdes (bulbe surtout)',
      signes: 'Hypersalivation, vomissements (parfois sanglants), diarrhée, douleur abdominale, abattement, tremblements.',
      notes: 'Même famille que le narcisse; plante forcée en pot l\'hiver.' },
    ...
    { nom: 'Azalée / Rhododendron', img: 'azalee.jpg', categorie: 'jardin', especes: ['chien', 'chat', 'oiseau', 'lapin', 'cheval', 'vache', 'mouton', 'chevre'], toxicite: 'Élevée',
      identification: 'Arbuste très populaire dans les jardins, couvert de fleurs en cloche roses, rouges, blanches ou mauves au printemps. Les feuilles sont brillantes, vertes et persistantes (souvent présentes toute l\'année).',
      mecanisme: 'Grayanotoxines (toutes les parties)',
    ...
    { nom: 'Canne des muets (Dieffenbachia)', img: 'dieffenbachia.jpg', categorie: 'interieur', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Modérée',
      identification: 'Grande plante d\'intérieur aux larges feuilles ovales vert foncé, souvent marbrées de crème ou de jaune pâle au centre. La tige charnue ressemble à une canne de bambou. Très répandue dans les bureaux et les maisons.',
      mecanisme: 'Oxalates de calcium insolubles (sève)',
    ...
    { nom: 'Cerisier de Virginie / cerisier sauvage (Prunus virginiana)', img: 'cerisier-virginie.jpg', categorie: 'sauvage', especes: ['chien', 'chat', 'cheval', 'vache', 'mouton', 'chevre'], toxicite: 'Très élevée (mortelle)',
      identification: 'Grand arbuste ou petit arbre avec de longues grappes de petites fleurs blanches au printemps, et de petites cerises rouges foncé à noires en été. L\'écorce des jeunes branches dégage une odeur d\'amande quand on la gratte. Très commun en lisière de forêt, en bord des chemins et partout au Québec.',
      mecanisme: 'Glycosides cyanogènes, surtout dans les feuilles flétries (gel, bris de branche, sécheresse) : libération de cyanure',
      signes: 'Muqueuses rouge vif, dyspnée, tachypnée, ataxie, convulsions, mort rapide. Surtout chez les ruminants et les chevaux.' },
    { nom: 'Cicutaire maculée (carotte à Moreau, Cicuta maculata)', img: 'cicutaire.jpg', categorie: 'sauvage', especes: ['chien', 'chat', 'cheval', 'vache', 'mouton', 'chevre'], toxicite: 'Très élevée (mortelle)',
      ...
      mecanisme: 'Cicutoxine (antagoniste des récepteurs GABA), surtout dans le rhizome',
    ...
    { nom: 'Ciguë maculée (grande ciguë, Conium maculatum)', img: 'cigue.jpg', categorie: 'sauvage', especes: ['chien', 'chat', 'cheval', 'vache', 'mouton', 'chevre'], toxicite: 'Très élevée (mortelle)',
      identification: 'Grande plante à tige creuse, couverte de taches rouges ou violettes à la base. Les feuilles sont très découpées et ressemblent à du persil ou à de la carotte. Dégage une odeur désagréable quand on la froisse. Pousse dans les champs, les terrains vagues, les fossés et les bords de routes, surtout dans le sud du Québec.',
    ...
    { nom: 'Colchique (Colchicum autumnale)', img: 'colchique.jpg', categorie: 'jardin', especes: ['chien', 'chat', 'oiseau', 'lapin', 'cheval', 'vache'], toxicite: 'Très élevée (mortelle)',
      identification: 'Petite fleur rose ou mauve qui pousse directement du sol en automne, sans feuilles visibles à ce moment (les feuilles apparaissent au printemps). Ressemble à un crocus. Bulbe souterrain. Plante de jardin ornementale.',
      mecanisme: 'Colchicine',
      signes: 'Vomissements et diarrhée hémorragiques, choc, atteinte hépatique/rénale, dépression médullaire, convulsions; signes parfois retardés de plusieurs jours.',
    ...
    { nom: 'Cyclamen', img: 'cyclamen.jpg', categorie: 'interieur', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Modérée à élevée',
      identification: 'Petite plante aux fleurs tombantes rose, rouge, mauve ou blanche, aux pétales recourbés vers l\'arrière. Les feuilles sont rondes ou en coeur, souvent marbrées de vert et de gris-argent. Vendue en pot à l\'automne et en hiver. Le tubercule (comme un oignon aplati) est enterré dans le pot.',
      mecanisme: 'Saponines terpénoïdes, concentrées dans le tubercule',
      signes: 'Hypersalivation, vomissements, diarrhée.',
      notes: 'Ingestion importante de tubercule : arythmies, convulsions, voire mort.' },
    { nom: 'Digitale (Digitalis purpurea)', img: 'digitale.jpg', categorie: 'jardin', especes: ['chien', 'chat', 'oiseau', 'lapin', 'cheval', 'vache'], toxicite: 'Très élevée (mortelle)',
      identification: 'Grande plante à fleurs tubulaires pendantes, rose fuchsia ou blanches, tachetées à l\'intérieur, disposées le long d\'une longue tige. Les feuilles sont grandes, douces au toucher et légèrement duveteuses. Plante de jardin ornementale, souvent biennale.',
    ...
    { nom: 'Érable rouge (Acer rubrum)', img: 'erable-rouge.jpg', categorie: 'sauvage', especes: ['cheval'], toxicite: 'Très élevée (mortelle chez le cheval)',
      identification: 'Grand arbre commun dans tout le Québec, reconnaissable à ses feuilles à cinq lobes qui virent au rouge écarlate à l\'automne. Les graines (samares) tournent en tombant comme des hélicoptères. Très présent dans les forêts, les parcs et les bords de routes de toute la province.',
      mecanisme: 'Toxicité propre aux équidés : les feuilles flétries ou séchées causent une anémie hémolytique sévère (corps de Heinz, méthémoglobinémie)',
    ...
    { nom: 'Fougère-aigle (Pteridium aquilinum)', img: 'fougere-aigle.jpg', categorie: 'sauvage', especes: ['cheval', 'vache', 'mouton', 'chevre'], toxicite: 'Modérée à élevée',
      identification: 'Grande fougère aux longues frondes divisées en forme de triangle. Pousse en colonies denses dans les clairières, les lisières de forêt et les terrains découverts, partout au Québec. C\'est l\'une des fougères les plus communes et les plus envahissantes de la province.',
      mecanisme: 'Thiaminase (carence en vitamine B1) chez le cheval; aplasie médullaire et effet cancérigène chez les bovins à ingestion chronique',
      signes: 'Chez le cheval : ataxie, signes neurologiques. Chez les bovins : hémorragies, aplasie médullaire.' },
    { nom: 'Gui (Viscum album / Phoradendron spp.)', img: 'gui.jpg', categorie: 'sauvage', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Modérée',
      identification: 'Plante parasite qui pousse en boule verte sur les branches d\'autres arbres (pommiers, peupliers, etc.). Les feuilles sont épaisses, vertes et persistantes; les baies sont blanches et collantes. Présent dans certaines régions du Québec, surtout dans les vergers et sur les arbres feuillus.',
      mecanisme: 'Lectines, phoratoxines',
      signes: 'Vomissements, diarrhée, hypotension, bradycardie, dyspnée (forte ingestion).',
    ...
    { nom: 'Houblon (Humulus lupulus)', img: 'houblon.jpg', categorie: 'jardin', especes: ['chien'], toxicite: 'Très élevée (mortelle)',
      identification: 'Plante grimpante vigoureuse aux grandes feuilles découpées à trois ou cinq lobes. Elle produit des cônes verts ressemblant à de petits ananas, utilisés pour fabriquer la bière. Cultivée dans les jardins comme plante ornementale ou pour la brasserie maison.',
      mecanisme: 'Mécanisme exact inconnu; réaction propre au chien (surtout lévriers)',
      signes: 'Hyperthermie maligne (>40,6 °C), tachypnée, tachycardie, tremblements, convulsions.',
      notes: 'Décès possible en moins de 6h sans traitement.' },
    { nom: 'Houx (Ilex spp.)', img: 'houx.jpg', categorie: 'jardin', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Faible',
      identification: 'Arbuste aux feuilles brillantes, vert foncé, aux bords dentés et épineux. Porte de petites baies rondes rouges (ou parfois jaunes) très décoratives en hiver. Utilisé comme décoration de Noël.',
      mecanisme: 'Saponines (baies et feuilles)',
    ...
    { nom: 'If (Taxus)', img: 'if.jpg', categorie: 'jardin', especes: ['chien', 'chat', 'oiseau', 'lapin', 'cheval', 'vache', 'mouton', 'chevre'], toxicite: 'Très élevée (mortelle)',
      identification: 'Conifère aux aiguilles plates, vert foncé dessus et plus pâles dessous, disposées en deux rangées le long des rameaux. En automne, il porte de petites baies rouges en forme de coupe avec une graine foncée au centre. Très courant dans les haies et les jardins paysagers.',
      mecanisme: 'Taxines (aiguilles, écorce, graines; les baies charnues sont moins toxiques mais la graine l\'est)',
      signes: 'Vomissements, tremblements, dyspnée, convulsions, arythmies; mort subite par insuffisance cardiaque aiguë possible sans signes prodromiques.',
      notes: 'Tueur classique des chevaux et ruminants : une très faible quantité de feuilles (fraîches ou sèches) suffit.' },
    { nom: 'Jonquille / Narcisse (Narcissus spp.)', img: 'jonquille.jpg', categorie: 'jardin', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Modérée à élevée',
      identification: 'Fleur bien connue du printemps, à pétales jaunes ou blancs entourant une trompette centrale. Les feuilles sont longues, plates et vert-bleu. Le bulbe ressemble à un oignon. Très plantée dans les jardins et les plates-bandes.',
      mecanisme: 'Lycorine et alcaloïdes (bulbe surtout)',
    ...
    { nom: 'Kalanchoé', img: 'kalanchoe.jpg', categorie: 'interieur', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Modérée à élevée',
      identification: 'Petite plante grasse très vendue avec des grappes de petites fleurs rouge, orange, jaune ou rose. Les feuilles sont charnues, épaisses et luisantes. Souvent offerte en cadeau.',
    ...
    { nom: 'Langue de belle-mère (Sansevieria)', img: 'sansevieria.jpg', categorie: 'interieur', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Faible à modérée',
      identification: 'Plante d\'intérieur facile à reconnaître : longues feuilles dressées, rigides, vert foncé avec des bandes horizontales jaunes ou grises. Les bords peuvent avoir une ligne jaune ou orange. Pousse dans les pots sans beaucoup d\'eau ni de soin.',
      mecanisme: 'Saponines',
      signes: 'Nausées, vomissements, diarrhée, hypersalivation. Toxicité généralement légère.' },
    { nom: 'Laurier-rose (Nerium oleander)', img: 'laurier-rose.jpg', categorie: 'jardin', especes: ['chien', 'chat', 'oiseau', 'lapin', 'cheval', 'vache', 'mouton', 'chevre'], toxicite: 'Très élevée (mortelle)',
      identification: 'Grand arbuste méditerranéen aux longues feuilles étroites, épaisses et vert foncé, disposées par trois. Les fleurs, simples ou doubles, sont rose vif, blanches ou rouges. Souvent en pot sur les terrasses et balcons, parfois planté dans les jardins dans les régions chaudes.',
      mecanisme: 'Glycosides cardiotoniques (toutes les parties)',
    ...
    { nom: 'Lis de la paix (Spathiphyllum)', img: 'lis-de-la-paix.jpg', categorie: 'interieur', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Modérée',
      identification: 'Plante d\'intérieur aux feuilles vert foncé brillantes et aux fleurs blanches en forme de voile avec un long piton blanc au centre. Très appréciée pour filtrer l\'air et souvent offerte en cadeau.',
      mecanisme: 'Oxalates de calcium insolubles (malgré son nom, ce n\'est pas un vrai lis mais une aracée)',
      signes: 'Irritation buccale, hypersalivation, oedème de la langue et des lèvres, vomissements, dysphagie.',
    ...
    { nom: 'Lys (toutes espèces de Lilium)', img: 'lys.jpg', categorie: 'jardin', especes: ['chat'], toxicite: 'Très élevée (mortelle)',
      identification: 'Grandes fleurs élégantes à six pétales, souvent mouchetées, dans les tons rose, rouge, orangé, jaune ou blanc, portées sur une haute tige garnie de feuilles étroites. Très populaires dans les bouquets et les jardins.',
      mecanisme: 'Néphrotoxicité propre au chat; principe actif inconnu (toutes les parties, y compris le pollen)',
      ...
      notes: 'Ingestion minime suffisante. La toxicité est propre au chat (le chien ne fait qu\'un trouble digestif léger).' },
    { nom: 'Monstera (faux philodendron, plante gruyère)', img: 'monstera.jpg', categorie: 'interieur', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Modérée',
      identification: 'Grande plante d\'intérieur très tendance aux larges feuilles vert foncé brillantes, percées de trous et de fentes caractéristiques qui lui donnent son surnom de plante gruyère. Les jeunes feuilles sont entières et deviennent découpées en grandissant.',
      mecanisme: 'Oxalates de calcium insolubles (même famille que le Dieffenbachia et le philodendron)',
    ...
    { nom: 'Muguet (Convallaria majalis)', img: 'muguet.jpg', categorie: 'jardin', especes: ['chien', 'chat', 'oiseau', 'lapin', 'cheval'], toxicite: 'Très élevée (mortelle)',
      identification: 'Petite plante de sous-bois et de jardin aux petites clochettes blanches pendantes, très parfumées, disposées en grappe. Les feuilles sont larges, ovales et vert tendre. Pousse en tapis dans les jardins à l\'ombre et en forêt. Fleurit au printemps.',
      mecanisme: 'Glycosides cardiotoniques (convallatoxine)',
      signes: 'Hypersalivation, vomissements, diarrhée, bradycardie, arythmies, hypotension, convulsions.',
      notes: 'Toxique même via l\'eau du vase. Plante de plate-bande très commune.' },
    { nom: 'Palmier de Sago (Cycas revoluta)', img: 'palmier-sago.jpg', categorie: 'interieur', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Très élevée (mortelle)',
      identification: 'Plante qui ressemble à un petit palmier avec des feuilles rigides disposées en couronne autour d\'une tige centrale épaisse. Ce n\'est pas un vrai palmier mais une cycas, une plante très ancienne. Souvent en pot à l\'intérieur ou sur les terrasses.',
      mecanisme: 'Cycasine',
      ...
      notes: 'Jusqu\'à 50% de mortalité; 1-2 graines peuvent être fatales.' },
    { nom: 'Philodendron', img: 'philodendron.jpg', categorie: 'interieur', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Modérée',
      identification: 'Plante grimpante ou buissonnante avec de grandes feuilles en forme de coeur, vert foncé et luisantes. La tige produit souvent de petites racines aériennes. Très résistante et facile à cultiver, présente dans de nombreux foyers.',
      mecanisme: 'Oxalates de calcium insolubles (toutes les parties)',
      signes: 'Irritation buccale immédiate, hypersalivation, oedème de la langue et des lèvres, vomissements, dysphagie.',
    ...
    { nom: 'Plante de jade (Crassula)', img: 'plante-jade.jpg', categorie: 'interieur', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Faible à modérée',
      identification: 'Petite plante grasse en forme d\'arbrisseau miniature avec de petites feuilles rondes, épaisses, charnues et vert vif, parfois bordées de rouge. La tige devient brune et ligneuse avec l\'âge.',
      mecanisme: 'Mécanisme inconnu',
      signes: 'Vomissements, diarrhée, dépression, incoordination (ataxie); rarement tremblements.',
    ...
    { nom: 'Plante maïs (Dracaena)', img: 'dracaena.jpg', categorie: 'interieur', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Modérée',
      identification: 'Grande plante d\'intérieur avec une longue tige souvent courbée au bout qui porte une touffe de longues feuilles arquées, souvent striées de jaune ou de blanc au centre. Ressemble à un petit tronc de palmier ou de maïs.',
      mecanisme: 'Saponines',
      signes: 'Vomissements, dépression, perte d\'appétit, hypersalivation, incoordination.',
      notes: 'Chez le chat, dilatation pupillaire et tachycardie possibles.' },
    { nom: 'Poinsettia (étoile de Noël)', img: 'poinsettia.jpg', categorie: 'interieur', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Faible',
      identification: 'Plante de Noël par excellence, avec de grandes bractées rouge vif (parfois blanches ou roses) qui ressemblent à des fleurs. Les véritables petites fleurs sont jaunes et discrètes au centre. Les feuilles sont vert foncé et légèrement veloutées.',
      mecanisme: 'Irritation buccale et gastrique par les diterpènes et la sève laiteuse',
      signes: 'Irritation buccale, vomissements, hypersalivation, rarement diarrhée; irritation cutanée possible au contact de la sève.',
    ...
    { nom: 'Pothos / lierre du diable (Epipremnum)', img: 'pothos.jpg', categorie: 'interieur', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Modérée',
      identification: 'Plante grimpante très populaire avec de grandes feuilles en forme de coeur, vert brillant, souvent marbrées ou panachées de jaune, de blanc ou de crème. Elle pousse rapidement et tombe en cascade des tablettes et des pots suspendus.',
      ...
      notes: 'Une des plantes d\'intérieur les plus répandues; signes habituellement locaux et spontanément résolutifs.' },
    { nom: 'Rhubarbe (feuilles)', img: 'rhubarbe.jpg', categorie: 'jardin', especes: ['chien', 'chat', 'cheval', 'vache', 'mouton', 'chevre'], toxicite: 'Modérée',
      identification: 'Plante de jardin aux très larges feuilles vert foncé portées par de longues tiges rouges ou roses (ce sont les tiges que l\'on mange). Les feuilles sont très grandes, nervurées et légèrement ondulées. Cultivée dans les potagers.',
      mecanisme: 'Oxalates solubles dans les feuilles (les tiges sont comestibles)',
      signes: 'Hypersalivation, vomissements; à forte dose, hypocalcémie et atteinte rénale par cristaux d\'oxalate de calcium.',
      notes: 'À distinguer des oxalates insolubles des aracées, qui n\'atteignent pas le rein.' },
    { nom: 'Tulipe (Tulipa spp.)', img: 'tulipe.jpg', categorie: 'jardin', especes: ['chien', 'chat', 'oiseau', 'lapin'], toxicite: 'Modérée',
      identification: 'Fleur printanière bien connue aux pétales simples ou doubles, dans toutes les couleurs, portée sur une tige droite avec deux ou trois larges feuilles vert-bleu. Le bulbe ressemble à un oignon et peut être facilement déterré par les chiens.',
      mecanisme: 'Tulipaline (bulbe surtout)',
  ...
  aliments: [
    ...
    { nom: 'Avocat', img: 'avocat.jpg', especes: ['chien', 'chat', 'furet', 'oiseau', 'lapin', 'rongeur'], toxicite: 'Variable selon l\'espèce (très élevée chez oiseaux, lapin, furet)',
      ...
      signes: 'Chez le chien et le chat : risque faible, surtout trouble digestif léger, plus le noyau (obstruction) et le gras (pancréatite). Chez les oiseaux, le lapin, le furet et les petits rongeurs : toxicité élevée à mortelle, nécrose du myocarde, oedème, détresse respiratoire, mort subite parfois en 24 à 48h.',
      notes: 'Ne jamais en donner aux oiseaux ni aux petits mammifères.' },
    { nom: 'Chocolat', img: 'chocolat.jpg', especes: ['chien', 'chat', 'furet', 'oiseau', 'lapin', 'rongeur'], toxicite: 'Élevée',
      ...
      notes: 'Toxique pour la plupart des espèces (furet, lapin, oiseaux, rongeurs); le chocolat noir et la poudre de cacao sont les plus concentrés.' },
    { nom: 'Agrumes', img: 'agrumes.jpg', especes: ['chien', 'chat'], toxicite: 'Faible',
      mecanisme: 'Acide citrique et huiles essentielles irritantes dans les tiges, feuilles, écorces, fruits et graines',
      signes: 'Irritation digestive légère; de petites doses ne causent généralement qu\'un léger trouble digestif.' },
    { nom: 'Noix de coco et huile de coco', img: 'coconut.jpg', especes: ['chien', 'chat'], toxicite: 'Faible',
      mecanisme: 'Huiles pouvant causer un trouble digestif en grande quantité',
    ...
    { nom: 'Raisins et raisins secs', img: 'raisins.jpg', especes: ['chien', 'chat', 'furet'], toxicite: 'Élevée',
      mecanisme: 'L\'acide tartrique est aujourd\'hui identifié comme le principe toxique probable',
      signes: 'Insuffisance rénale possible chez certains animaux; la sensibilité varie beaucoup d\'un chien à l\'autre.',
      notes: 'Des atteintes rénales sont aussi rapportées chez le furet; à éviter.' },
    { nom: 'Noix de macadamia', img: 'noix-macadame.jpg', especes: ['chien'], toxicite: 'Modérée',
      mecanisme: 'Mécanisme inconnu; toxicité documentée uniquement chez le chien',
      signes: 'Faiblesse, dépression, vomissements, tremblements et hyperthermie. Signes généralement dans les 12h suivant l\'ingestion, durant environ 12 à 48h.' },
    ...
    { nom: 'Noix (amandes, pacanes, noix de Grenoble, etc.)', img: 'noix.jpg', especes: ['chien', 'chat', 'furet'], toxicite: 'Faible à modérée',
      mecanisme: 'Riches en huiles et matières grasses',
    ...
    { nom: 'Oignon, ail et ciboulette', img: 'oignons.jpg', especes: ['chien', 'chat', 'furet', 'oiseau', 'rongeur'], toxicite: 'Modérée à élevée',
      ...
      signes: 'Anémie hémolytique possible. Le chat est plus sensible, mais le chien est aussi à risque selon la quantité.',
    ...
    { nom: 'Viande, œufs et os crus ou insuffisamment cuits', img: 'os-cru.jpg', especes: ['chien', 'chat'], toxicite: 'Faible à modérée',
      mecanisme: 'Bactéries (Salmonella, E. coli) et protéines antinutritives (avidine dans les oeufs crus)',
      signes: 'La viande et les oeufs crus peuvent contenir des bactéries dangereuses pour l\'animal comme pour l\'humain. Les oeufs crus contiennent aussi une protéine (avidine) nuisant à l\'absorption de la biotine (problèmes de peau/pelage).',
      notes: 'Les os crus présentent un risque de blessure ou d\'obstruction du tube digestif.' },
    { nom: 'Sel', img: 'sel.jpg', especes: ['chien', 'chat', 'oiseau', 'furet'], toxicite: 'Modérée à élevée',
      mecanisme: 'Intoxication aux ions sodium en grande quantité',
    ...
    { nom: 'Xylitol', img: 'xylitol.jpg', especes: ['chien'], toxicite: 'Très élevée',
      mecanisme: 'Édulcorant présent dans la gomme, les bonbons, les produits de boulangerie et le dentifrice. Libération massive d\'insuline provoquant une hypoglycémie sévère.',
      signes: 'Faiblesse, ataxie, convulsions; à plus forte dose, atteinte hépatique aiguë possible.',
      notes: 'Sensibilité moindre chez le lapin; données limitées chez le chat.' },
    { nom: 'Pâte à pain crue (levure)', img: 'pate-a-pain.jpg', especes: ['chien', 'chat', 'furet'], toxicite: 'Élevée',
      mecanisme: 'La levure fermente dans le système digestif et produit des gaz et de l\'éthanol',
      signes: 'Ballonnement douloureux de l\'estomac pouvant évoluer en torsion (urgence vitale). La fermentation produit aussi de l\'éthanol, donc hypoglycémie et dépression du SNC en parallèle.' },
  ],
  medicaments: [
    { nom: 'AINS (ibuprofène, naproxène, aspirine)', especes: ['chien', 'chat'], toxicite: 'Élevée',
      mecanisme: 'Inhibition des prostaglandines (COX)',
      signes: 'Vomissements (parfois sanglants), ulcères gastriques et hémorragie digestive, douleur abdominale, puis insuffisance rénale aiguë. À forte dose, signes neurologiques (ataxie, convulsions, coma) et acidose. Le chat y est plus sensible que le chien (glucuronidation limitée). Le naproxène a une longue demi-vie, donc une toxicité prolongée et un risque accru.',
      notes: 'Pas d\'antidote spécifique : décontamination, protecteurs gastriques, fluidothérapie.' },
    { nom: 'Acétaminophène (paracétamol / Tylenol)', especes: ['chien', 'chat', 'furet'], toxicite: 'Très élevée (mortelle chez le chat)',
      mecanisme: 'Métabolite toxique (NAPQI) qui épuise le glutathion',
      signes: 'Chez le chat et le furet, dose toxique très basse (dès 10 mg/kg) : méthémoglobinémie (sang brun, muqueuses cyanosées), corps de Heinz et anémie hémolytique, oedème de la face et des pattes, dyspnée. Chez le chien, surtout hépatotoxicité (nécrose centrolobulaire, ictère); néphrotoxicité possible à forte dose.',
      notes: 'Antidote : N-acétylcystéine (NAC); bleu de méthylène et vitamine C contre la méthémoglobinémie.' },
    { nom: 'Antidépresseurs (ISRS, IRSN, tricycliques)', especes: ['chien', 'chat'], toxicite: 'Modérée à élevée',
      mecanisme: 'ISRS (fluoxétine, sertraline), IRSN et tricycliques (amitriptyline, clomipramine). Le chat est plus sensible que le chien.',
      signes: 'Petits surdosages : sédation ou agitation, hypersalivation, vomissements, mydriase, tremblements, hyperthermie. Forts surdosages : ataxie, dysphorie, nystagmus, convulsions, et syndrome sérotoninergique (rigidité, hyperthermie, tachycardie).',
      notes: 'Antidote du syndrome sérotoninergique : cyproheptadine.' },
    { nom: 'Stimulants (amphétamines, médicaments pour le TDAH)', especes: ['chien', 'chat'], toxicite: 'Élevée à très élevée',
      mecanisme: 'Amphétamines et dérivés (Adderall, Vyvanse, Ritalin / méthylphénidate), sympathomimétiques',
      signes: 'Début souvent rapide (30 min à 2h; plus tardif pour les formes à libération prolongée) : agitation, hyperactivité, halètement, mydriase, tremblements, convulsions, tachycardie, hypertension, hyperthermie. Risque de syndrome sérotoninergique.',
      notes: 'Soins : sédation (acépromazine ou chlorpromazine), refroidissement, cyproheptadine, contrôle des convulsions.' },
    { nom: 'Décongestionnants (pseudoéphédrine, éphédrine)', especes: ['chien', 'chat'], toxicite: 'Élevée',
      mecanisme: 'Sympathomimétiques présents dans les médicaments contre le rhume et certains suppléments',
      signes: 'Agitation, halètement, mydriase, tremblements, tachycardie, hypertension, hyperthermie, convulsions. Tableau stimulant proche des amphétamines; marge de sécurité étroite chez le chien et le chat.' },
    { nom: 'Benzodiazépines et somnifères (zolpidem, etc.)', especes: ['chien', 'chat'], toxicite: 'Modérée à élevée',
      mecanisme: 'Diazépam, alprazolam, zolpidem (Ambien) et apparentés',
      signes: 'Le plus souvent : dépression du SNC, sédation, ataxie, faiblesse, hypotension; parfois excitation paradoxale (agitation, vocalises), surtout avec le zolpidem. Dépression respiratoire possible à forte dose.',
      notes: 'Le flumazénil peut servir d\'antidote dans certains cas.' },
    { nom: 'Médicaments cardiaques (bêta-bloquants, bloqueurs calciques)', especes: ['chien', 'chat'], toxicite: 'Élevée',
      mecanisme: 'Bêta-bloquants (aténolol, propranolol) et bloqueurs des canaux calciques (amlodipine, diltiazem)',
      signes: 'Bradycardie, hypotension parfois sévère et réfractaire, faiblesse, effondrement, troubles du rythme. Les formes à libération prolongée retardent et allongent les signes.',
      notes: 'Prise en charge en soins intensifs (fluides, calcium, vasopresseurs, parfois émulsion lipidique IV).' },
    { nom: 'Vitamine D et analogues (cholécalciférol, calcipotriène)', especes: ['chien', 'chat'], toxicite: 'Très élevée',
      mecanisme: 'Suppléments de vitamine D, multivitamines, rodenticides au cholécalciférol et crèmes pour le psoriasis (calcipotriène)',
      signes: 'Hypercalcémie et hyperphosphatémie : vomissements, diarrhée, abattement, faiblesse, polyuro-polydipsie, puis minéralisation des tissus mous et insuffisance rénale aiguë. Signes parfois retardés de 12 à 72h.',
      notes: 'Lapins, oiseaux et chevaux y sont aussi sensibles. Marge étroite; surveillance du calcium et du phosphore sur plusieurs jours.' },
    { nom: '5-Fluorouracile (crème anticancéreuse)', especes: ['chien', 'chat'], toxicite: 'Très élevée (souvent mortelle chez le chien)',
      mecanisme: 'Crème ou lotion dermatologique utilisée contre les kératoses et certains cancers cutanés',
      signes: 'Même une faible exposition est dramatique chez le chien : vomissements et diarrhée sévères, convulsions réfractaires en moins d\'une heure, puis aplasie médullaire. Pronostic réservé à sombre; urgence absolue.' },
    { nom: 'Baclofène (myorelaxant)', especes: ['chien', 'chat'], toxicite: 'Très élevée',
      mecanisme: 'Myorelaxant humain à marge de sécurité très étroite',
      signes: 'Vocalises, désorientation, hypersalivation, vomissements, faiblesse, puis dépression marquée du SNC, dépression respiratoire, bradycardie, convulsions, coma.',
      notes: 'Soins intensifs prolongés souvent nécessaires.' },
    { nom: 'Antibiotiques chez les herbivores et petits rongeurs (risque iatrogène)', especes: ['lapin', 'cobaye', 'chinchilla', 'rongeur'], toxicite: 'Très élevée (mortelle)',
      mecanisme: 'Risque iatrogène, pas une ingestion accidentelle. Les antibiotiques qui ciblent le Gram positif (pénicillines, céphalosporines, lincosamides comme la clindamycine, macrolides comme l\'érythromycine) détruisent la flore intestinale et laissent proliférer Clostridium difficile : entérotoxémie souvent mortelle.',
      signes: 'Anorexie, diarrhée, déshydratation, hypothermie, abattement (signes 6 à 48h après le début du traitement). La streptomycine et la dihydrostreptomycine sont en plus directement toxiques chez la gerbille, le cobaye, le hamster et la souris.',
...
const TOXIDROMES = [
  {
    ...
    traitement: 'Atropine pour les signes muscariniques (0,1 à 2,0 mg/kg, 1/4 IV et le reste SQ ou IM, à répéter aux 1 à 2h jusqu\'au contrôle des sécrétions). Pralidoxime / 2-PAM pour les signes nicotiniques (20 mg/kg IV sur 15 à 30 min, idéalement dans les premières 24h).',
  },
  {
...
const DECONTAMINATION = [
  {
    ...
    objectif: 'Réduire les lésions en retirant le produit de l\'oeil.',
    points: [
      ...
      'Poser un collier élisabéthain pour éviter que l\'animal ne se traumatise l\'oeil.',
...
// ─── PHOTO TOXIQUE (avec repli si absente) ───────────────
